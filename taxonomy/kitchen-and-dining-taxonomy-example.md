# Kitchen & Dining Taxonomy Example / 厨房与餐饮 分类树示例
...
└── Kitchen & Dining / 厨房与餐饮
    ...
    │   └── baking pan set
    │   └── silicone baking mat
    ├── Bar Tools & Drinkware / 酒吧工具与饮具
    │   └── insulated tumbler
    │   └── cocktail shaker
    ├── Coffee, Tea & Espresso Appliances / 咖啡茶饮与浓缩设备
    │   └── coffee maker concept
    │   └── tea kettle
    ├── Cookware / 炊具
    │   └── frying pan concept
    │   └── pot set
    ├── Dining & Entertaining / 餐桌与宴客用品
    │   └── serving tray concept
    │   └── plates set
    ├── Glassware & Drinkware / 玻璃器皿与饮具
    │   └── water bottle
    │   └── travel mug
    ├── Kitchen & Table Linens / 厨房与餐桌布艺
    │   └── dish cloths pack
    │   └── oven mitts
    ├── Kitchen Utensils & Gadgets / 厨房用具与小工具
    │   └── meat thermometer
    │   └── kitchen scale
