# Tools & Home Improvement Taxonomy Example / 工具与家装 分类树示例
...
└── Tools & Home Improvement / 工具与家装
    ...
    │   └── wall hooks
    │   └── screws assortment
    ├── Kitchen & Bath Fixtures / 厨卫五金
    │   └── shower head
    │   └── faucet accessory
    ├── Lighting & Ceiling Fans / 照明与吊扇
    │   └── LED light strip
    │   └── desk lamp
    ├── Measuring & Layout Tools / 测量与布局工具
    │   └── measuring tape
    │   └── laser level
    ├── Paint, Wall Treatments & Supplies / 油漆墙面与用品
    │   └── paint roller
    │   └── masking tape
    ...
    │   └── door lock
    │   └── safety glasses
    ├── Storage & Home Organization / 收纳与家居整理
    │   └── tool organizer
    │   └── storage hooks
```
