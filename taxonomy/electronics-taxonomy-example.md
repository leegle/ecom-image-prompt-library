# Electronics Taxonomy Example / 电子产品 分类树示例
...
└── Electronics / 电子产品
    ...
    │   └── USB hub
    │   └── laptop charger
    ├── GPS & Navigation / GPS与导航
    │   └── GPS navigator
    │   └── tracker
    ├── Headphones / 耳机
    │   └── wireless earbuds
    │   └── over-ear headphones
    ├── Home Audio & Theater / 家庭音响与影院
    │   └── soundbar
    │   └── smart speaker
    ...
    │   └── label maker
    │   └── calculator
    ├── Portable Audio & Video / 便携音视频
    │   └── tablet
    │   └── streaming stick
    ├── Security & Surveillance / 安防监控
    │   └── outdoor camera
    │   └── video doorbell
    ├── Service & Replacement Plans / 服务与更换计划
    │   └── service plan card
    │   └── warranty insert
    ├── Televisions & Video / 电视与视频
    │   └── smart TV
    │   └── TV mount
    ├── Video Game Consoles & Accessories / 游戏主机与配件
    │   └── controller
    │   └── gaming headset
    ├── Video Projectors / 投影仪
    │   └── mini projector
    │   └── projector screen
    ├── Wearable Technology / 可穿戴设备
    │   └── smartwatch
    │   └── fitness tracker
    ├── eBook Readers & Accessories / 电子阅读器与配件
    │   └── eReader
    │   └── eReader case
```
