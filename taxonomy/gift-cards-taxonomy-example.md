# Gift Cards Taxonomy Example / 礼品卡 分类树示例
...
└── Gift Cards / 礼品卡
    ├── Birthday / 生日
    │   └── birthday gift card design
    │   └── birthday mini envelope
    ├── Christmas / 圣诞节
    │   └── holiday gift card design
    │   └── winter gift card concept
    ├── Father’s Day / 父亲节
    │   └── fathers day gift card design
    │   └── dad appreciation card
    ├── For Her / 送给她
    │   └── floral gift card design
    │   └── elegant gift card concept
    ├── For Him / 送给他
    │   └── for him gift card design
    │   └── minimal gift card concept
    ├── Graduation / 毕业
    │   └── graduation gift card design
    │   └── cap-themed envelope
    ├── Kids / 儿童
    │   └── kids gift card design
    │   └── colorful gift sleeve
    ├── Mother’s Day / 母亲节
    │   └── mothers day gift card design
    │   └── floral appreciation card
    ├── Thank You & Appreciation / 感谢与致谢
    │   └── thank you gift card design
    │   └── gratitude card concept
    ├── Wedding & Engagement / 婚礼与订婚
    │   └── wedding gift card design
    │   └── elegant occasion card
```
