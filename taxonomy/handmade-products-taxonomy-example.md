# Handmade Products Taxonomy Example / 手工制品 分类树示例
...
└── Handmade Products / 手工制品
    ├── Handmade Baby / 手工婴幼儿用品
    │   └── personalized baby gift concept
    │   └── soft baby keepsake
    ├── Handmade Beauty & Personal Care / 手工美妆个护
    │   └── handmade balm tin
    │   └── artisan soap jar
    ├── Handmade Clothing & Accessories / 手工服饰与配件
    │   └── crochet accessory concept
    │   └── custom keychain
    ├── Handmade Home Décor / 手工家居装饰
    │   └── custom wall sign
    │   └── engraved home piece
    ├── Handmade Jewelry / 手工珠宝
    │   └── name bracelet concept
    │   └── engraved necklace
    ├── Handmade Kitchen & Dining / 手工厨房餐厨
    │   └── engraved cutting board
    │   └── custom mug concept
    ├── Handmade Pet Supplies / 手工宠物用品
    │   └── engraved pet tag
    │   └── custom collar accessory
    ├── Handmade Stationery & Party Supplies / 手工文具与派对用品
    │   └── birthday card craft concept
    │   └── custom invitation mockup
    ├── Handmade Toys & Games / 手工玩具与游戏
    │   └── crochet toy concept
    │   └── wood puzzle mockup
```
