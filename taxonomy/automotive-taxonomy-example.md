# Automotive Taxonomy Example / 汽车用品 分类树示例
...
└── Automotive / 汽车用品
    ...
    │   └── interior cleaner
    │   └── car air freshener
    ├── Exterior Accessories / 汽车外饰配件
    │   └── windshield sunshade
    │   └── car cover
    ├── Interior Accessories / 汽车内饰配件
    │   └── car phone mount
    │   └── seat organizer
    ├── Light & Lighting Accessories / 车灯与照明配件
    │   └── LED car light
    │   └── headlight bulb
    ├── Motorcycle & ATV / 摩托车与 ATV
    │   └── motorcycle cover
    │   └── ATV accessory
    ├── Oils & Fluids / 机油与车用液体
    │   └── motor oil bottle
    │   └── windshield washer fluid
    ├── Paint & Paint Supplies / 汽车喷漆与喷漆用品
    │   └── touch-up paint pen
    │   └── spray paint
    ├── Performance Parts & Accessories / 性能零件与配件
    │   └── air filter
    │   └── performance gauge
    ├── RV Parts & Accessories / 房车零件与配件
    │   └── RV water hose
    │   └── RV leveling blocks
    ├── Replacement Parts / 替换零件
    │   └── cabin air filter
    │   └── wiper blade
    ├── Tools & Equipment / 汽车工具与设备
    │   └── tire inflator
    │   └── diagnostic tool
    ├── Wheels & Tires / 轮胎与轮毂
    │   └── tire pressure gauge
