# Arts, Crafts & Sewing Taxonomy Example / 艺术、手工与缝纫 分类树示例
...
└── Arts, Crafts & Sewing / 艺术、手工与缝纫
    ├── Beading & Jewelry Making / 串珠与首饰制作
    │   └── beads
    │   └── rhinestones
    │   └── jewelry glue
    ├── Craft Supplies / 手工材料
    ...
    │   └── felt sheets
    │   └── fabric bundles
    ├── Fabric Painting & Dyeing / 布料绘画与染色
    │   └── fabric paint
    │   └── fabric markers
    │   └── tie dye kit
    ├── Knitting & Crochet / 针织与钩针
    │   └── crochet hooks
    │   └── knitting needles
    │   └── knitting kits
    ├── Needlework / 刺绣与针线手工
    │   └── embroidery kit
    │   └── cross stitch kit
    ├── Organization & Storage / 手工收纳与整理
    │   └── craft storage box
    │   └── bead organizer
    ├── Painting, Drawing & Art Supplies / 绘画、素描与美术用品
    │   └── acrylic paint markers
    │   └── acrylic paint set
    │   └── paint brushes
    ├── Photo Transfer & Coloring Supplies / 照片转印与涂色用品
    │   └── coloring markers
    │   └── transfer paper
    ├── Printmaking / 版画与印刷手工
    │   └── linocut tools
