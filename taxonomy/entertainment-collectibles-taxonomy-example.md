# Entertainment Collectibles Taxonomy Example / 娱乐收藏品 分类树示例
...
└── Entertainment Collectibles / 娱乐收藏品
    ├── Animation / 动画收藏
    │   └── character art card set
    │   └── animation poster print
    ├── Apparel / 服饰收藏
    │   └── band tee collectible concept
    │   └── tour hoodie concept
    ├── Artwork By Celebrities / 名人艺术作品
    │   └── signed art print concept
    │   └── gallery-style art card
    ├── Backstage Passes / 后台通行证
    │   └── concert pass concept
    │   └── event laminate concept
    ├── Books / 书籍收藏
    │   └── collector book cover concept
    │   └── special edition book concept
    ├── Comic Art / 漫画艺术
    │   └── comic art print concept
    │   └── panel artwork poster
    ├── Comic Books / 漫画书
    │   └── comic issue cover concept
    │   └── variant cover concept
    ├── Figurines / 手办摆件
    │   └── collectible figurine concept
    │   └── mini collectible figure
    ├── Photographs / 照片收藏
    │   └── glossy collectible photo concept
    │   └── portrait print card
    ├── Trading Cards / 集换式卡牌
    │   └── trading card bundle concept
    │   └── foil card display
```
